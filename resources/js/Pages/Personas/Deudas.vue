                ...
                <div class="max-w-7xl mx-auto sm:px-4 lg:px-6">
                    <div class="bg-white border p-2 dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                      ...
                      <div class="aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-lg xl:aspect-h-8 xl:aspect-w-7">
                        ...
                        <div class="text-gray-900 text-center dark:text-gray-100" :key="id">Deuda desde: {{ deudor.created_at }}</div>
                        <div class="text-gray-900 text-center dark:text-gray-100" :key="id">Monto a pagar: ${{ deudor.monto_a_pagar }}</div>

                        <div class="text-green-500 text-center dark:text-gray-100" v-if="deudor.monto_pagado == deudor.monto_a_pagar">
                            <p>Pago completado.</p>
                        </div>
