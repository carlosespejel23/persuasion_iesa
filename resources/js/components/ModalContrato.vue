...
<template>
    <button id="button" type="button" class="text-black rounded-lg text-sm">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6 space-y-6">
                    <p class="text-base text-justify leading-relaxed text-black dark:text-gray-400">
                      ...
                      Sabías que nuestro país fue el primer país en todo el mundo en el que se le conocieron constitucionalmente los derechos y la protección a los trabajadores frente a los patrones. Esto sucedió en el año 1917, durante la promulgación de nuestra Constitución Política de los Estados Unidos Mexicanos. 
                    </p>
                </div>
                <!-- Pie de ventana modal -->
                <div class="flex justify-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                    <button id="closeButton" type="button" class="text-white bg-blue-950 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Cerrar</button>
                </div>
            </div>
        </div>
    </div>
