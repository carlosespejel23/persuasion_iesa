...
<template>
    ...
    <label for="email-address-icon" class="block mb-2 text-md font-medium text-gray-900 dark:text-white">Correo Electrónico</label>
    
    <div class="relative">
        <div class="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none">
            <font-awesome-icon icon="fa-solid fa-envelope" class="faemail"/>
        </div>
